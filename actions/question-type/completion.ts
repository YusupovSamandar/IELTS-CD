...
export const updateCompletionParagraph = async ({
  ...
  console.log('updateCompletionParagraph called with id:', id);
  ...
  console.log('Updating completion paragraph...');
  ...
  const assessmentPath = `/assessments/${completion.questionGroup.part.assessmentId}`;
  console.log('Revalidating path:', assessmentPath);
  revalidatePath(assessmentPath);
